...
<div class="w-full flex justify-center">
  <Card href="/app/asset" size="lg" class="p-4 bg-white rounded-lg border border-gray-200 shadow-md">
    ...
    <div class="mt-2">
      <p class="text-gray-700 text-sm">${asset.price}</p>
      <p>Here be a price chart</p>
    </div>
  </Card>
</div>
